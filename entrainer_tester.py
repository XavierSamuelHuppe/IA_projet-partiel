...
algo_starting_time = time()
classifieur_bayes_naif_iris.train(dataset_iris[0], dataset_iris[1])
algo_end_time = time()
print("\nTemps d'exécution de l'algorithme : " + str(algo_end_time - algo_starting_time) + "\n")
print("---------------------------------------------------------\n")
...
algo_starting_time = time()
classifieur_bayes_naif_congressional.train(dataset_congressional[0], dataset_congressional[1])
algo_end_time = time()
print("\nTemps d'exécution de l'algorithme : " + str(algo_end_time - algo_starting_time) + "\n")
print("---------------------------------------------------------\n")
...
algo_starting_time = time()
classifieur_bayes_naif_monks_1.train(dataset_monks_1[0], dataset_monks_1[1])
algo_end_time = time()
print("\nTemps d'exécution de l'algorithme : " + str(algo_end_time - algo_starting_time) + "\n")
print("---------------------------------------------------------\n")
...
algo_starting_time = time()
classifieur_bayes_naif_monks_2.train(dataset_monks_2[0], dataset_monks_2[1])
algo_end_time = time()
print("\nTemps d'exécution de l'algorithme : " + str(algo_end_time - algo_starting_time) + "\n")
print("---------------------------------------------------------\n")
...
print("Entrainement du classifieur Bayes Naif avec le dataset Monks_2")
algo_starting_time = time()
classifieur_bayes_naif_monks_3.train(dataset_monks_3[0], dataset_monks_3[1])
algo_end_time = time()
print("\nTemps d'exécution de l'algorithme : " + str(algo_end_time - algo_starting_time) + "\n")
print("---------------------------------------------------------\n")
...
algo_starting_time = time()
classifieur_bayes_naif_iris.test(dataset_iris[2], dataset_iris[3])
algo_end_time = time()
print("\nTemps d'exécution de l'algorithme : " + str(algo_end_time - algo_starting_time) + "\n")
print("---------------------------------------------------------\n")
...
algo_starting_time = time()
classifieur_bayes_naif_congressional.test(dataset_congressional[2], dataset_congressional[3])
algo_end_time = time()
print("\nTemps d'exécution de l'algorithme : " + str(algo_end_time - algo_starting_time) + "\n")
print("---------------------------------------------------------\n")
...
algo_starting_time = time()
classifieur_bayes_naif_monks_1.test(dataset_monks_1[2], dataset_monks_1[3])
algo_end_time = time()
print("\nTemps d'exécution de l'algorithme : " + str(algo_end_time - algo_starting_time) + "\n")
print("---------------------------------------------------------\n")
...
algo_starting_time = time()
classifieur_bayes_naif_monks_2.test(dataset_monks_2[2], dataset_monks_2[3])
algo_end_time = time()
print("\nTemps d'exécution de l'algorithme : " + str(algo_end_time - algo_starting_time) + "\n")
print("---------------------------------------------------------\n")
...
algo_starting_time = time()
classifieur_bayes_naif_monks_3.test(dataset_monks_3[2], dataset_monks_3[3])
algo_end_time = time()
print("\nTemps d'exécution de l'algorithme : " + str(algo_end_time - algo_starting_time) + "\n")
print("---------------------------------------------------------\n")
